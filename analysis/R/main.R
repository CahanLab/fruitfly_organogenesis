...
# plot out UMAP and proportion plots for for stage 13-16 wild types 
# Fig 1b, 1c
# Supp Fig 1a, 1b
...
# to explore the x chromosome gene expressions ratio in our germ cell populations 
...
# These scripts are also semi-interesting enough that we don't want to delete them. 
