...
TARGET_dir = file.path("results", ANALYSIS_VERSION, "early_wt12_clusters_enrichment")
...
object@meta.data$manual_celltypes = paste0(object@meta.data$seurat_clusters, "_", object@meta.data$manual_celltypes)
