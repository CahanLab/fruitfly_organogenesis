...
# load in the cell type harmonization/unification table 
...
# calculate the various proportion of cell types in Seroka et al's data 
...
# calculate the various proportion of cell types in Calderon et al's data 
...
# calculate the spearman correlation between our data and Seroka et al's data
...
# calculate the spearman correlation between our data and Calderon et al's data
...
# in the terminal run the python scripts in analysis/results/v18/cross_study_comparison_wt13/Seroka_comparison_scn
...
# in the terminal run the python scripts in analysis/results/v18/cross_study_comparison_wt13/Calderon_comparison_scn
...
# in the terminal run the python scripts in analysis/results/v18/cross_study_comparison_wt13/Our_data_comparison_Seroka
...
# in the terminal run the python scripts in analysis/results/v18/cross_study_comparison_wt13/Our_data_comparison_Calderon
